...
<head>
    ...
    <meta name="Description" content="SN is a group-oriented social media platform">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('const_assets/favicon.svg') }}">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand pb-2 pt-0" href="{{ url('/') }}">
                    <img src="{{ asset('const_assets/favicon.svg') }}"
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown align-items-center d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    {{-- ISPRAVLJENO: Oba linka sada vode na glavnu stranicu (dashboard.feed) --}}
